            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    const Text(
                      '4.7', // You might want to make this dynamic later
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.black,
...
class _ProductImages extends StatelessWidget {
  // Made stateless as no internal state is needed
  const _ProductImages({Key? key, required this.image}) : super(key: key);
...
class _ProductDescriptionState extends State<_ProductDescription> {
  bool showFullDescription = false; // State to manage description visibility
        ...
        Padding(
          ...
          child: GestureDetector(
            onTap: () {
              ...
              widget.pressOnSeeMore?.call(); // Call the original callback
            },
            child: Row(
              children: const [
                Text(
